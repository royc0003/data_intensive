...
import httpx
import asyncio
from services.shared.models import Book, CustomerBase, CustomerResponse, MobileCustomerResponse, RelatedBook
...
CUSTOMERS_SERVICE_URL = os.getenv("CUSTOMERS_SERVICE_URL")
